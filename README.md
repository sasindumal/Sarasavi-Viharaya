...
- **Admin Dashboard** — Role-based (super_admin, admin, moderator) with full CRUD for events, milestones, blessings, acknowledgments, tags, and users https://sarasaviviharaya.vercel.app
